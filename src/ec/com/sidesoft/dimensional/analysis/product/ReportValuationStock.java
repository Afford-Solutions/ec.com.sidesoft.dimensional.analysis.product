...
import org.openbravo.erpCommon.ad_reports.SummaryProductCategory;
...
public class ReportValuationStock extends HttpSecureAppServlet {
  ...
  private static final String NO_COST_TEMPLATE = "ec/com/sidesoft/dimensional/analysis/product/ReportValuationStock2";
  ...
  private void buildData(HttpServletResponse response, VariablesSecureApp vars, String strDate,
    ...
    if (vars.commandIn("FIND")) {
      printPageDataSheet(response, vars, strDate, strOrganization, strWarehouse,
          strCategoryProduct, strCurrencyId, isWarehouseConsolidation, data, strCostType, ca, orgs);
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strCostType, CostingAlgorithm ca, Set<String> orgs) throws IOException,
      ServletException {
  ...
  private void printPageDataXLS(HttpServletResponse response, VariablesSecureApp vars,
      ReportValuationStockData[] data, String strCostType, CostingAlgorithm ca) throws IOException,
      ServletException {
    ...
    String strReportName = "@basedesign@/ec/com/sidesoft/dimensional/analysis/product/ReportValuationStockExcel.jrxml";
  ...
  private void printPageDataPDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    String strSubReportName = "/ec/com/sidesoft/dimensional/analysis/product/SumaryProductCategory.jrxml";
